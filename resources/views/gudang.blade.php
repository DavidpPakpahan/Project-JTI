...
@section('container')
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{ Request::is('barang') ? 'active' : '' }}" href="/barang" href="#">Barang</a>
            </li>
            <li class="nav-item">
  ...
  <div class="mt-4">
    <a href="/tambah-gudang" class="btn btn-info"><i class="bi bi-plus-circle-fill"></i> Tambahkan Gudang</a>
  </div>
