...
@section('container')
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link {{ Request::is('barang-keluar') ? 'active' : '' }}" href="/barang-keluar">Barang Keluar</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="mt-4">
    <a href="#" class="btn btn-info"><i class="bi bi-plus-circle-fill"></i> Tambahkan Barang Masuk</a>
  </div>
